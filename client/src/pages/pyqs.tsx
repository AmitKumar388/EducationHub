...
import { subjects, semesters } from "@shared/schema";
          ...
          <div className="flex items-center space-x-3 mb-4">
            ...
            <div>
              ...
              <p className="text-slate-600 dark:text-slate-400">
                Semester PYQs and practice papers from top universities
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white dark:bg-slate-800 rounded-xl p-6 border border-slate-200 dark:border-slate-700 mb-8">
          <form onSubmit={handleSearchSubmit} className="mb-6">
            <div className="relative">
              <Input
                type="text"
                placeholder="Search PYQs by subject, year, or topic..."
          ...
          {isLoading ? (
            ...
            <>
              <div className="flex items-center justify-between mb-6">
                <p className="text-slate-600 dark:text-slate-400">
                  Found {resources.length} PYQ papers
                </p>
              </div>
            ...
            <div className="text-center py-12">
              <div className="w-24 h-24 bg-slate-200 dark:bg-slate-700 rounded-full flex items-center justify-center mx-auto mb-4">
                <i className="fas fa-question-circle text-slate-400 text-2xl"></i>
              </div>
