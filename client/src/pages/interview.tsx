          ...
          <div className="flex items-center space-x-3 mb-4">
            ...
            <div>
              ...
              <p className="text-slate-600 dark:text-slate-400">
                Comprehensive interview preparation and tips for success
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white dark:bg-slate-800 rounded-xl p-6 border border-slate-200 dark:border-slate-700 mb-8">
          <form onSubmit={handleSearchSubmit} className="mb-6">
            <div className="relative">
              <Input
                type="text"
                placeholder="Search interview resources, tips, and guides..."
          ...
          {isLoading ? (
            ...
            <>
              <div className="flex items-center justify-between mb-6">
                <p className="text-slate-600 dark:text-slate-400">
                  Found {resources.length} interview resources
                </p>
              </div>
